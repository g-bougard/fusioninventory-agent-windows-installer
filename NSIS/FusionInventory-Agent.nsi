...
!define FIA_TASK_NETINVENTORY_RELEASE "2.2.1"
...
!else
   !if "${PRODUCT_RELEASE_TYPE}" == "${RELEASE_TYPE_CANDIDATE}"
      ...
      !define PRODUCT_VERSION "2.3.19-RC1"
      ...
      ; If PRODUCT_VERSION is a commit then
      ;    define the following symbols as '0.0.0.0'
      !define FILE_VERSION "2.3.17.9909"
   ...
   !else
      ...
      !define PRODUCT_VERSION "g8285f24-dev"
